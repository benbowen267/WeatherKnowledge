...
def app():
    ...
    def Weather_Now():
        df0 = pd.read_html('https://www.weatherzone.com.au/nt/alice-springs/alice-springs', header=0)
        df0[1].pop("Unnamed: 1") #remove unused coloumns
        df0[1].pop("Unnamed: 3") #remove unused coloumns
        df0[2].pop("Unnamed: 1")
    #layer two of data
        df1 = pd.read_html('https://www.weatherzone.com.au/nt/alice-springs/alice-springs',header=1)
    ...
    def Weather_Now1():
    #data= []
        dfs = pd.read_html('https://www.weatherzone.com.au/nt/alice-springs/alice-springs',header=1)
    #for df in dfs:
...
#Pressure=float(Pressure)  
    ...
    st.write("Today we are looking at Alice Springs forecast through the lens of the ??????? seasons")
    #st.write(df1)
